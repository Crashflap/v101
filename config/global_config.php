...
/***************************************
  ...
  ***************************************/
  ...
  #define('_SESSION_PATH_', _ADMIN_PATH_ . 'ses_9361c3cfc1cc537d1644879f75a071c3' . $path_separator);
  ...
  $dbn    = 'crashfla_ai';    # dev database name/prefix
  $dbu    = 'crashfla_666';       # dev database username
  $dbp    = 'nswAA6900';  # dev database password
  ...
  $remember_up_to = 10;
  $debugemail = 'support@crashflap.com';
  ...
  // Set Misc Data
  //------------------------------------------------------------------------
  $botmaster_name = 'Bjorn V Ramstrom';
  $charset = 'UTF-8';
...
*/
  ...
  define('BUGS_EMAIL', 'bugs@crashflap.com');
